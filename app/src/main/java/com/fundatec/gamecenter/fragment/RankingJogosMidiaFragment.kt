...
import kotlinx.android.synthetic.main.fragment_ranking_jogos_midia.*

private const val ARG_PARAM1 = "param1"

class RankingJogosMidiaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerRankingJogosMidia.layoutManager = LinearLayoutManager(activity, RecyclerView.VERTICAL, false)
        readJogos()
    }

    private fun readJogos() {
        var url = "https://gamecenter-api.herokuapp.com/gamecenter/jogos/ranking-midia"
        ...
        var request = GsonRequest(url, Array<JogosData>::class.java, null, Response.Listener { response ->
            ...
            recyclerRankingJogosMidia.adapter = adapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ranking_jogos_midia, container, false)
    }

    companion object {
        @JvmStatic
        fun newInstance(param1: String) =
            RankingJogosMidiaFragment().apply {
